...
<div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 ">
  <div className="mx-auto max-w-lg">
    ...
    <form action="#" className="mb-0 mt-1 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8 bg-white " >
      ...
      <p className="text-center text-3xl text-rose-500 font-medium">Add Product</p>
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            id='imageUpload'
            name='image'
            className="w-full rounded-lg border border-gray-900  p-3 pe-12 text-sm shadow-sm"
      ...
      <label htmlFor="text" className='text-black font-bold'>User:</label>
        <div className="relative">
          <input
            ...
            id='user'
            name='user'
            className="w-full rounded-lg border border-gray-900 text-red-700  p-4 pe-12 text-sm shadow-sm"
            placeholder="User"
          />
        </div>
      </div>
